...
| Linear Finetune  | [📖](https://github.com/csinva/imodelsX/blob/master/demo_notebooks/linearfinetune.ipynb), [🗂️](https://csinva.io/imodelsX/linear_finetune.html), ⠀⠀[🗂️](http://csinva.io/imodelsX/linear_finetune.html) | Black-box model | Finetune a single linear layer<br/>on top of LLM embeddings |
| (Coming soon!)                 | ⌛                                        |                    |  We plan to support other interpretable models like [RLPrompt](https://arxiv.org/abs/2205.12548), <br/> [CBMs](https://arxiv.org/abs/2007.04612), [NAMs](https://proceedings.neurips.cc/paper/2021/hash/251bd0442dfcc53b5a761e050f8022b8-Abstract.html), and [NBDT](https://arxiv.org/abs/2004.00221)  
