...
| Linear Finetune  | [🗂️](http://csinva.io/imodelsX/linear_finetune.html) | Scikit-learn interface to finetune a single linear layer on top of embeddings from an LLM for classification/regression |
